var size = 0;
var placement = 'point';
function categories_TinggiElevasi_3(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case '0-400m':
...
var style_TinggiElevasi_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_TinggiElevasi_3(feature, value, size, resolution, labelText,
